          ...
          <div className="clearfix">
            <div className="pull-left">
              <ButtonGroup>
                ...
                {(this.props.csv || this.props.excel) && 
                  <DropdownButton
                    ...
                    bsSize="small"
                    pullRight>
                      <ul class="export-dropdown-list">
                        {this.props.csv &&
                        <li>
                          <a href={'/superset/csv/' + this.props.query.id + '/True'}>
                            <i className="fa fa-file-text-o" /> {t('CSV')}
                          </a>
                        </li>}
                        ...
                        {this.props.excel &&
                        <li>
                          <a href={'/superset/excel/' + this.props.query.id + '/True'}>
                            <i className="fa fa fa-file-excel-o" /> {t('Excel')}
                          </a>
                        </li>}
                      </ul>
                  </DropdownButton>
